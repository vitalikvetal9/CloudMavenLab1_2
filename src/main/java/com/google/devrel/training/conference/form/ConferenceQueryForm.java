...
public class ConferenceQueryForm {
	...
	public static enum Field {
		CITY("city", FieldType.STRING), TOPIC("topics", FieldType.STRING), MONTH("month",
				FieldType.INTEGER), MAX_ATTENDEES("maxAttendees", FieldType.INTEGER);
	...
	/**
	 * Holds the first inequalityFilter for checking the feasibility of the whole
	 * query.
	 */
