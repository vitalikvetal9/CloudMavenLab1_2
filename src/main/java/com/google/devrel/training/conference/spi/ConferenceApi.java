...
public class ConferenceApi {
	...
	public Profile saveProfile(final ProfileForm p, final User u) throws UnauthorizedException {
		if (u == null)
	...
	public List<Conference> getConferencesCreated(final User u) throws UnauthorizedException {
		if (u == null)
			throw new UnauthorizedException("Authorization required");
