...
public class Conference {
	...
	/**
	 * Updates the Conference with ConferenceForm. This method is used upon object
	 * creation as well as updating existing Conferences.
	 *
	...
	public void updateWithConferenceForm(ConferenceForm conferenceForm) {
		...
		// However, if there are already some seats allocated, we should subtract that
		// numbers.
